...
import poTermsRoutes from './modules/poTerms/poTerms.routes';
import grnRoutes from './modules/grn/grn.routes';
import notificationsRoutes from './modules/notifications/notifications.routes';
import billingStatusRoutes from './modules/billingStatus/billingStatus.routes';
import siteAccountsRoutes from './modules/siteAccounts/siteAccounts.routes';
import expensesRoutes from './modules/expenses/expenses.routes';
import recruitmentRoutes from './modules/recruitment/recruitment.routes';
import attendanceRoutes from './modules/attendance/attendance.routes';
import projectUnitsRoutes from './modules/projectUnits/projectUnits.routes';
...
api.use('/po-terms', poTermsRoutes);
api.use('/grns', grnRoutes);
api.use('/notifications', notificationsRoutes);
api.use('/billing-status', billingStatusRoutes);
api.use('/site-accounts', siteAccountsRoutes);
api.use('/expenses', expensesRoutes);
api.use('/recruitment', recruitmentRoutes);
api.use('/attendance', attendanceRoutes);
api.use('/project-units', projectUnitsRoutes);
